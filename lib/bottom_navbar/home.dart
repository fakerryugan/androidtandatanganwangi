...
class HomePage extends StatelessWidget {
  ...
  children: [
    Expanded(
      child: buildButton(Icons.qr_code, 'Scan QR', () {
    ...
    Expanded(
      child: buildButton(Icons.verified, 'File verified', () {}),
    ),
    Expanded(
      child: buildButton(Icons.mobile_friendly, 'Verifikasi TTD', () {
        Navigator.push(context,
            MaterialPageRoute(builder: (context) => Fileverifikasi()));
      }),
    ),
  ],
)
                      ...
                      if (state.documents.isNotEmpty)
                        ...state.documents.map((file) {
                          return ListTile(
                            ...
                            subtitle:
                                Text('Diunggah: ${file['uploaded_at'] ?? ''}'),
                            trailing: const Icon(
