          ...
          children: [
            ...
            Positioned(
              ...
              child: GestureDetector(
                onPanUpdate: (details) {
                  setState(() {
                    final newSize = _size + (details.delta.dx + details.delta.dy) / 2;
                    _size = newSize.clamp(50.0, 300.0);
                    _position = Offset(
                      _position.dx.clamp(0, widget.constraints.maxWidth - _size),
                      _position.dy.clamp(0, widget.constraints.maxHeight - _size),
                    );
